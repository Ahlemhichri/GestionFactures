...
<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Modifier la  Facture</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
                        ...
                        @method('PUT')
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" value="{{$facture->designation}}" name="designation" required> </div>
								</div>
								</div>
								<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Prix HT</label>
										<input class="form-control"  type="text" value="{{$facture->prix_ht}}" name="prix_ht" required> </div>
								</div>
								</div>
								<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<textarea  class="form-control"   type="text"  name="description" value="{{$facture->description}}" required>
                                       </textarea>
								...
								<button type="submit" class="btn btn-primary buttonedit">Modifier  
								</button>
                               </div>
						</form>
					</div>
